          ...
          <TabsContent value="reports" className="space-y-6">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              <Card className="border-pink-100 dark:border-pink-900/20 bg-white/50 dark:bg-gray-900/50 backdrop-blur-sm">
                <CardHeader>
                  <CardTitle className="flex items-center space-x-2">
                    ...
                    <span>Employee Trends</span>
                  </CardTitle>
                  <CardDescription>Monthly workforce statistics</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-3">
              ...
              <Card className="border-pink-100 dark:border-pink-900/20 bg-white/50 dark:bg-gray-900/50 backdrop-blur-sm">
                <CardHeader>
                  ...
                  <CardDescription>HR process efficiency</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-3">
                    <div className="text-center p-3 border rounded-lg border-pink-100 dark:border-pink-900/20 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950/10 dark:to-emerald-950/10">
                      ...
                      <div className="text-sm text-muted-foreground">Onboarding Time</div>
                    </div>
                    <div className="text-center p-3 border rounded-lg border-pink-100 dark:border-pink-900/20 bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-950/10 dark:to-cyan-950/10">
                      <div className="text-2xl font-bold text-blue-600">4.5 hrs</div>
              ...
              <Card className="border-pink-100 dark:border-pink-900/20 bg-white/50 dark:bg-gray-900/50 backdrop-blur-sm">
                <CardHeader>
                  ...
                  <CardDescription>Employee feedback scores</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-muted-foreground">Job Satisfaction</span>
                      <span className="font-semibold text-green-600">89%</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-muted-foreground">Management Rating</span>
                    ...
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-muted-foreground">Benefits Rating</span>
            ...
            <Card className="border-pink-100 dark:border-pink-900/20 bg-white/50 dark:bg-gray-900/50 backdrop-blur-sm">
              <CardHeader>
                <CardTitle className="flex items-center space-x-2">
                  ...
                  <span>Workforce Performance Metrics</span>
                </CardTitle>
                <CardDescription>Key performance indicators for human resources management</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card className="border-pink-100 dark:border-pink-900/20 bg-white/50 dark:bg-gray-900/50 backdrop-blur-sm">
              <CardHeader>
                ...
                <CardDescription>High-performance departments and areas for improvement</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="space-y-3">
                    ...
                    {[
                      { dept: "Engineering", score: 95, employees: 156 },
                      { dept: "Sales", score: 92, employees: 89 },
                      { dept: "Marketing", score: 88, employees: 67 },
                    ].map((dept, index) => (
                      <div key={index} className="flex items-center justify-between p-3 border rounded-lg border-pink-100 dark:border-pink-900/20 bg-white/50 dark:bg-gray-800/50">
                        ...
                        <Badge variant="outline" className="bg-green-50 text-green-700 dark:bg-green-900/20 dark:text-green-300">
                          {dept.score}% satisfaction
                        </Badge>
                      </div>
                    ))}
                  </div>
                  <div className="space-y-3">
                    <h4 className="font-semibold text-sm">HR Action Items</h4>
                    {[
                      { action: "Implement flexible work policy in Operations", priority: "High" },
                      { action: "Conduct leadership training for middle management", priority: "Medium" },
                      { action: "Review compensation structure for IT department", priority: "High" },
                    ].map((item, index) => (
