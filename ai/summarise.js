...
Do not include explanations or formatting backticks, just return the JSON response.`
    ...
    try {
      const jsonRaw = text.slice(7, text.length - 4);
       console.log(jsonRaw);
...
// Test the function
console.log(
  await aiResponse("The manager repeatedly made unwelcome sexual comments towards the intern despite her objections, and threatened to fire her if she reported it."));